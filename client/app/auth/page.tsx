...
export default function AuthPage({ showBackButton = true, onBack }: AuthPageProps) {
  ...
  const validateUsername = (username: string): string | null => {
    if (!username.trim()) return isLogin ? "Email or username is required" : "Username is required"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center p-4">
      ...
      <motion.div className="relative w-full max-w-md" variants={containerVariants} initial="hidden" animate="visible">
        {/* Glow Effect */}
        <motion.div
        ...
        <motion.div variants={itemVariants}>
          <Card className="relative bg-black/80 backdrop-blur-xl border-gray-800/50 shadow-2xl">
            ...
            <CardHeader className="space-y-8 pb-8">
              ...
              {/* Tab Switcher */}
              <motion.div className="flex bg-gray-900/50 rounded-lg p-1 border border-gray-800" variants={itemVariants}>
                <motion.button
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <CardDescription className="text-gray-400 mt-2">
                      {isLogin ? "Sign in to your StarkFinder account" : "Join StarkFinder and start exploring"}
                    </CardDescription>
                  </motion.div>
                </AnimatePresence>
              </motion.div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  {isLogin && (
                    ...
                    >
                      <motion.label className="flex items-center space-x-2 cursor-pointer" whileHover={{ scale: 1.02 }}>
                        <input
                          type="checkbox"
