        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-6">
            <div className="flex border-b border-gray-700">
              <button
                className={`px-6 py-3 text-sm font-medium ${activeTab === "deployed"
              ...
              <button
                className={`px-6 py-3 text-sm font-medium ${activeTab === "generated"
                    ? "border-b-2 border-purple-500 text-white"
                    : "text-gray-400 hover:text-gray-300"
                  }`}
              ...
              <button
                className={`px-6 py-3 text-sm font-medium ${activeTab === "cached"
                    ? "border-b-2 border-purple-500 text-white"
                    : "text-gray-400 hover:text-gray-300"
                  }`}
    ...
    <div className="bg-gray-800 bg-opacity-70 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
      <div className="p-6">
        <div className="flex justify-between items-start mb-4">
          ...
          <span
            className={`px-2 py-1 rounded text-xs ${type === "deployed"
