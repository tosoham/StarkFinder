...
const ToggleBtn = ({mode, onClick}: ToggleBtnProps)=> {
   if(mode === "on") {
    return <button onClick={onClick}><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="2.75" y="5.75" width="18.5" height="13.5" rx="6.75" stroke="#297E71" stroke-width="1.5"/>
